...
#   -- from the flex(1) man page
proc revealsend::YY_FLUSH_BUFFER {} {
    variable yy_current_buffer
    variable index_
    variable done_
...
#   -- from the flex(1) man page
proc revealsend::yyrestart {new_file} {
    variable yyin
...
#   -- from the flex(1) man page
proc revealsend::YY_INPUT {buf result max_size} {
    variable yyin
...
#   -- from the flex(1) man page
proc revealsend::yy_scan_string {str} {
    variable yy_current_buffer
    variable yyin
...
set SPLIT_ 258
    ...
    while {1} {
        ...
        # rule 1: split
        if {[regexp -start $index_ -indices -line -nocase -- {\A(split)} $yy_current_buffer match] > 0 && \
                [lindex $match 1] - $index_ + 1 > $yyleng} {
            set yytext [string range $yy_current_buffer $index_ [lindex $match 1]]
            set yyleng [string length $yytext]
            set matched_rule 1
